...
I'm generally less familiar with `tmap` but it can be used to quickly make maps (including interactive maps). Note that maps can also be made in base R (using `plot`).
